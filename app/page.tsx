...
const movieData = {
  "1": {
    ...
    poster: "/posters/continuum-dvd-movie-cover.webp",
    year: "2024",
    rating: "TV-PG",
    duration: "45 min",
  ...
  "2": {
    ...
    poster: "/posters/torch-song-trilogy-movie-poster.webp",
    year: "2024",
    rating: "TV-14",
    duration: "120 min",
  ...
  "3": {
    ...
    poster: "/posters/guns-of-the-magnificent-seven-italian-movie-cover.webp",
    year: "2024",
    rating: "TV-PG",
    duration: "90 min",
  ...
  "4": {
    ...
    poster: "/posters/a-e-i-o-u-das-schnelle-alphabet-der-liebe-german-movie-poster.webp",
    year: "2024",
    rating: "TV-14",
    duration: "60 min",
  ...
  "5": {
    ...
    poster: "/posters/hasse-tage-en-karlekshistoria-swedish-movie-poster.webp",
    year: "2024",
    rating: "TV-G",
    duration: "75 min",
  ...
  "6": {
    id: "6",
    title: "SENNA हिन्दी",
    poster: "/posters/rugrats-movie-poster.webp",
    year: "2024",
    rating: "TV-PG",
    duration: "150 min",
  ...
  "7": {
    id: "7",
    title: "REFUGEE",
    poster: "/posters/the-big-clock-french-movie-poster.webp",
    year: "2024",
    rating: "TV-14",
    duration: "135 min",
  ...
  "8": {
    id: "8",
    title: "YELLOW HEART",
    poster: "/posters/mille-dollari-sul-nero-german-dvd-movie-cover.webp",
    year: "2024",
    rating: "TV-MA",
    duration: "110 min",
        ...
        <section className="relative h-[80vh] min-h-[500px] flex items-center overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div 
              ...
              style={{
                backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.6) 40%, rgba(0,0,0,0.2) 70%, rgba(0,0,0,0.0) 100%), url(/herolanscapeposter.jpg)`
              }}
            />
          </div>
          {/* Content Row */}
