...
export default function BuyerSettingsPage() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    bio: "Content acquisition specialist with 5+ years of experience in media licensing and distribution."
  })
  ...
  const [preferences, setPreferences] = useState({
    ...
    content: {
      preferredGenres: ["Drama", "Documentary", "Biography"],
      maxBudget: 50000,
        ...
        <div className="lg:col-span-3">
          ...
          {activeTab === "preferences" && (
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">Preferred Genres</h4>
                  <div className="flex flex-wrap gap-2">
                    {["Drama", "Documentary", "Biography", "Reality TV", "Music", "Comedy", "Action", "Thriller"].map((genre) => (
                      <Badge
                        key={genre}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Input
                      type="number"
                      value={preferences.content.maxBudget}
                      onChange={(e) => setPreferences({
                        ...preferences,
                        content: {...preferences.content, maxBudget: parseInt(e.target.value)}
                      })}
                      className="w-32"
                    />
                ...
                <div>
                  <h4 className="font-semibold mb-3">Preferred Regions</h4>
                  <div className="flex flex-wrap gap-2">
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h5 className="font-medium">Purchase History</h5>
                        <p className="text-sm text-muted-foreground">Show purchase history to sellers</p>
                      </div>
                      <Button
                        variant={preferences.privacy.showPurchaseHistory ? "default" : "outline"}
                        size="sm"
                      >
                        {preferences.privacy.showPurchaseHistory ? "Visible" : "Hidden"}
                      </Button>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Allow sellers to message you</p>
                      </div>
                      <Button
